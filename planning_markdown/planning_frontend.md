...
6. Analytics dashboard:  Create a another page which can be accessed through a link with the text "Submission stats" and have it open to a analytics dashboard with 
 - detection split (pie chart)
 - appeal rates (how many for each transparency label)
 - submission char count - average for pass and average for fail 

 Add the GET REST APIs for this